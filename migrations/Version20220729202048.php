...
final class Version20220729202048 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Result (pokemonUuid CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', impressions INT NOT NULL, upVotes INT NOT NULL, score INT NOT NULL, PRIMARY KEY(pokemonId)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
